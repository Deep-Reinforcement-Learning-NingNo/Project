...
wandb.init(
    project="flappy-bird-rl",       # 🧠 Change to your desired project name
    name=f"DDPG-run-{wandb.util.generate_id()}",  # Optional: run name
    config={
        "algorithm": "DDPG",
...
for episode in tqdm(range(n_episodes)):
    ...
    "actor_loss": last_a_loss,
    "critic_loss": last_c_loss
})
