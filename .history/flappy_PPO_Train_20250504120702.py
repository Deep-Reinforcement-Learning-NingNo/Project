...
save_interval = 100
save_path = f"./saved_models/ppo-lr{learning_rate:.0e}-bs{batch_size}-clip{clip_epsilon}-ep{epochs}-n_episode{n_episodes}"
...
wandb.init(
    ...
    name=f"PPO-lr{learning_rate:.0e}-bs{batch_size}-clip{clip_epsilon}-ep{epochs}-n_epsisode{n_episodes}",
    config={
        "algorithm": "PPO",
        "n_observations": n_observations,
        "n_actions": num_of_action,
