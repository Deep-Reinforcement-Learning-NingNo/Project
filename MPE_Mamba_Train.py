...
# from RL_Algorithm.Function_based.MAMBA2 import Mamba2ModelBasedRL
...
# save_interval = 100
# save_path = f"./saved_models/mamba_mpe_simple_spread"
# wandb_name = f"MAMBA2-MPE-v2"
...
#         avg_reward_100 = total_reward / save_interval
#         avg_policy_loss_100 = total_policy_loss / save_interval
#         avg_value_loss_100 = total_value_loss / save_interval
#         avg_step_100 = total_step / save_interval

#         wandb.log({
#             "avg_reward_100": avg_reward_100,
#             "avg_policy_loss_100": avg_policy_loss_100,
#             "avg_value_loss_100": avg_value_loss_100,
#             "avg_step_count_100": avg_step_100,
#             "max_step_100": max_step,
#             "episode": episode + 1
#         })

#         print(f"[SUMMARY] Ep {episode+1} | AvgReward100: {avg_reward_100:.2f} | "
#               f"PolicyLoss100: {avg_policy_loss_100:.4f} | ValueLoss100: {avg_value_loss_100:.4f} | "
#               f"AvgSteps100: {avg_step_100:.1f} | MaxStep100: {max_step}")
...
#         path = os.path.join(save_path, f"mamba_policy_ep{episode+1}.pt")
...
# for episode in tqdm(range(n_episodes)):
#     # Randomize landmark positions before episode start
#     for landmark in base_env.unwrapped.world.landmarks:
